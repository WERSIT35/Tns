...
export class SeoService {
  ...
  initDefaultMetaInformation() {
    ...
    this.setMetaTags({
      ...
      keywords: 'Tenebi, Teni, ტენი, ტენები, ტენების დამზადება,ტენი,ელექტრო ტენი, ელექტრო გამაცხელებელი, გამაცხელებელი, ტოსტერის გამაცხელებელი, წყლის გამაცხელებელი, გრილის გამაცხელებელი, სარეცხი მანქანის გამაცხელებელი, ვენტილაციის გამაცხელებელი, ღუბელის ტენები, ტოსტერის ტენები, გრილის ტენები, თერმოსტატები, ყავის აპარატის ტენები, სამრეწველო ტენები, სარეცხი მანქანის ტენები, ვენტილაციის ტენები',
      author: 'Tenebi',
      robots: 'index, follow',
